...
// 1. On récupère les données saisies au début
var nom = player.GetVar("SaisieNomcandidat3"); 
var concession = player.GetVar("saisieconcession1");

// 2. On prépare l'adresse de la page avec les infos "attachées" derrière
var url = "bilan.html?nom=" + encodeURIComponent(nom) + "&concession=" + encodeURIComponent(concession);
