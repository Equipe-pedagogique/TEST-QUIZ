...
// 1. Récupération des variables de votre module
// Assurez-vous que l'orthographe est identique dans Storyline
var nomCandidat = player.GetVar("SaisieNomcandidat3");
var nomConcession = player.GetVar("saisieconcession1");

// 2. Préparation de l'URL vers votre fichier
// On ajoute les infos après le point d'interrogation pour que bilan.html puisse les lire
var monFichier = "bilan.html";
var parametres = "?nom=" + encodeURIComponent(nomCandidat) + "&concession=" + encodeURIComponent(nomConcession);

// 3. Commande d'ouverture de la page
window.open(monFichier + parametres, "_blank");
}
